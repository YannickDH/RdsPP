...
public class InternalRdsPPLexer extends Lexer {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRdsPP.g:3131:9: ( ( 'a' .. 'z' | 'A' .. 'Z' | RULE_INT ) ( 'a' .. 'z' | 'A' .. 'Z' | RULE_INT | '.' | '/' | '_' )* )
            // InternalRdsPP.g:3131:11: ( 'a' .. 'z' | 'A' .. 'Z' | RULE_INT ) ( 'a' .. 'z' | 'A' .. 'Z' | RULE_INT | '.' | '/' | '_' )*
            {
            // InternalRdsPP.g:3131:11: ( 'a' .. 'z' | 'A' .. 'Z' | RULE_INT )
            int alt1=3;
            switch ( input.LA(1) ) {
            case 'a':
            case 'b':
            ...
            switch (alt1) {
                ...
                case 2 :
                    ...
                    break;
                case 3 :
                    // InternalRdsPP.g:3131:30: RULE_INT
                    {
                    mRULE_INT(); 
            ...
            // InternalRdsPP.g:3131:40: ( 'a' .. 'z' | 'A' .. 'Z' | RULE_INT | '.' | '/' | '_' )*
            loop2:
            do {
                int alt2=7;
                switch ( input.LA(1) ) {
            	...
            	case 2 :
            	    ...
            	    break;
            	case 3 :
            	    // InternalRdsPP.g:3131:59: RULE_INT
            	    {
            	    mRULE_INT(); 
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            // InternalRdsPP.g:3133:19: ( ( '0' .. '9' )+ )
            // InternalRdsPP.g:3133:21: ( '0' .. '9' )+
            {
            // InternalRdsPP.g:3133:21: ( '0' .. '9' )+
            int cnt3=0;
            loop3:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRdsPP.g:3135:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalRdsPP.g:3135:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalRdsPP.g:3135:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt6=2;
            ...
            switch (alt6) {
                case 1 :
                    // InternalRdsPP.g:3135:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalRdsPP.g:3135:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop4:
                    do {
                        int alt4=3;
                    ...
                    break;
                case 2 :
                    // InternalRdsPP.g:3135:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalRdsPP.g:3135:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop5:
                    do {
                        int alt5=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRdsPP.g:3137:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalRdsPP.g:3137:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalRdsPP.g:3137:24: ( options {greedy=false; } : . )*
            loop7:
            do {
                int alt7=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRdsPP.g:3139:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalRdsPP.g:3139:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalRdsPP.g:3139:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRdsPP.g:3141:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalRdsPP.g:3141:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalRdsPP.g:3141:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt11=0;
            loop11:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRdsPP.g:3143:16: ( . )
            // InternalRdsPP.g:3143:18: .
            {
            matchAny(); 
